...
export const SCANNER_RUNBOOK = [
  ...
  "Approve the Windows UAC prompt if it appears. A command window will stay open while the scan runs and will show a success or error message at the end.",
  "After success, compliance-results.json will be created on the Desktop.",
